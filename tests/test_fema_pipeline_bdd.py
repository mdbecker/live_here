    ...
    def test_given_fema_exports_when_pipeline_runs_then_both_factors_are_ranked(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with counties.open("w", newline="") as stream:
                writer = csv.DictWriter(stream, fieldnames=["fips", "name", "state", "geography_vintage", "latitude", "longitude", "coordinate_vintage"])
                writer.writeheader()
                writer.writerows([
                    {"fips": "01001", "name": "Autauga County", "state": "AL", "geography_vintage": "2019", "latitude": "0", "longitude": "0", "coordinate_vintage": "2020"},
                    {"fips": "01003", "name": "Baldwin County", "state": "AL", "geography_vintage": "2019", "latitude": "0", "longitude": "1", "coordinate_vintage": "2020"},
                ])
            exports = {}
            ...
            config = {"mode": "research", "geography_source": "counties", "factors": ["hazard_burden", "resilience"], "iterations": 20, "seed": 7, "adapters": {"hazard_burden": {"sources": ["hazard_burden"]}, "resilience": {"sources": ["resilience"]}}, "sources": sources}
