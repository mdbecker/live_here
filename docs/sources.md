...
| Specialty groceries | Project-archived specialty-grocery screening workbook, County Density Ranking sheet | Stable project input under `data/sources/` | `specialty_grocery_density_1020_city_restricted_statewide_expansion.xlsx` | 319 represented counties; absent or blank counties receive explicit lower-bound zeroes; proxy counts may overlap city catchments |
